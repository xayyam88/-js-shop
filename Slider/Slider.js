class Slider {
    constructor(images, buttons, pages, duration = 1000) {
        this.images = images;
    ...
    __addActiveClass(index) {
        ...
        this.pages[index].classList.add("slider__page-li_active");
    }
    __removeActiveClass(index) {
        this.images[index].classList.remove("active");
        this.pages[index].classList.remove("slider__page-li_active");
    }
    __setIndex(number) {
